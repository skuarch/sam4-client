 ...
 * @author skuarch
 */
public class Port extends javax.swing.JDialog {

    //==========================================================================
    /**
     * Creates new form Port
     */
    public Port(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(getContentPane());
        setIconImage(Toolkit.getDefaultToolkit().getImage(Port.class.getResource("/views/images/sam_icon.png")));        
    }
