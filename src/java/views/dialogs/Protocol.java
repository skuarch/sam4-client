 ...
 * @author skuarch
 */
public class Protocol extends javax.swing.JDialog {

    //==========================================================================
    /**
     * Creates new form Protocol
     */
    public Protocol(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(getContentPane());
        setIconImage(Toolkit.getDefaultToolkit().getImage(Protocol.class.getResource("/views/images/sam_icon.png")));  
    }
