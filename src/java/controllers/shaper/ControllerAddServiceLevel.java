 ...
 * @author skuarch
 */
public class ControllerAddServiceLevel extends Controller {
    ...
    //==========================================================================
    public ControllerAddServiceLevel(String collector, ControllerServiceLevel controllerServiceLevel) {
    ...
    public void setupInterface() {
        ...
        serviceLevel.setTitle("Add Service Level");
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    ...
                    serviceLevel.getjButton2().setText("add");
                    ...
                    hm.put("request", "get default data service level");
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    ...
                    hm.put("data", data);
                    hm.put("collector", collector);
                    hm.put("request", "save service level");
