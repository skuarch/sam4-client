...
public class ControllerFilters {
    ...
    //==========================================================================
    public ControllerFilters(String collector) {
    ...
    public void setupInterface() {
        ...
        genericTable.setName("manage filters");
    ...
    //==========================================================================    
    private void add() {
        ControllerAddFilter cap = new ControllerAddFilter(collector, this);
        cap.setupInterface();
        cap.setVisible(true);
    }
    ...
    private void edit() {
        ...
        try {
            ...
            if (row < 0) {
                NOTIFICATIONS.information("Please select a filter", true);
                return;
            }

            id = (String) genericTable.getjTable().getValueAt(row, 0);

            cef = new ControllerEditFilter(collector, id, this);
            cef.setupInterface();
            cef.setVisible(true);
    ...
    public void reloadTable() {
        ...
        try {
            ...
            hm = HashMapUtilities.getHashMapShaper();
            hm.put("collector", collector);
            hm.put("request", "get initial data filters");
