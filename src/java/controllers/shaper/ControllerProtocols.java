 ...
 * @author skuarch
 */
public class ControllerProtocols {
    ...
    //==========================================================================
    public ControllerProtocols(String collector) {
        this.collector = collector;
        genericTable = new GenericTable();
    } // end ControllerProtocols

    //==========================================================================
    public void setupInterface() {

        genericTable.getjProgressBar().setIndeterminate(true);
        genericTable.setName("manage protocols");
    ...
    //==========================================================================    
    private void add() {
        ControllerAddProtocol cap = new ControllerAddProtocol(collector, this);
        cap.setupInterface();
        cap.setVisible(true);
    }
    ...
    private void edit() {
        ...
        ControllerEditProtocol cep = null;
        int row = 0;
        String id = null;
        ...
        try {
            ...
            if (row < 0) {
                NOTIFICATIONS.information("Please select a protocol", true);
                return;
            }

            id = (String) genericTable.getjTable().getValueAt(row, 0);

            cep = new ControllerEditProtocol(collector, id, this);
            cep.setupInterface();
            cep.setVisible(true);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    hm.put("request", "delete protocols");
                    hm.put("id", id);
    ...
    public void reloadTable() {
        ...
        try {
            ...
            hm = HashMapUtilities.getHashMapShaper();
            hm.put("collector", collector);
            hm.put("request", "get initial data protocols");
