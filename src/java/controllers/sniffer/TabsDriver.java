...
public class TabsDriver {
    ...
    private static final ControllerSniffer CS = ControllerSniffer.getInstance();
            ...
            public void run() {
                ...
                try {
                    ...
                    if (navigator.getTabCount() < 1) {
                        CS.setRightComponent(navigator);
                    ...
                    panel = (JPanel) new PanelCreator().createPanelSniffer(hm);                    
